    ...
    <>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-20 md:px-6">
        <div className="rounded-[2.5rem] bg-paper-radial p-8 text-stone-950 md:p-12">
          <p className="text-sm uppercase tracking-[0.32em] text-teal-700">Monetization</p>
          <h2 className="mt-4 max-w-3xl font-display text-4xl font-semibold md:text-6xl">Pro делает review глубже и доску выразительнее</h2>
          <p className="mt-4 max-w-2xl text-sm leading-6 text-stone-700 md:text-base">Premium skins, advanced AI Coach, расширенный review и выделение профиля подготовлены как реальный SaaS-сценарий через Stripe.</p>
