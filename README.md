...
- @lichess-org/stockfish-web and stockfish.js copied into public runtime assets during install/build
...
- Stockfish / @lichess-org/stockfish-web / stockfish.js: browser chess engine distributions. This repository uses GPL-3.0-only for compatibility.
